...
public class Main {
    public static void main(String[] args) {
        ...
        //Creando Vertices
        test.agregarTienda(0,"D1 San Alonso",1,2,"Carrera 16");
        test.agregarTienda(1,"D1 San Francisco",1,2,"Carrera 25");
        test.agregarBodega(2,"Bodega el mas barato",1,2,"Carrera 59");
        //Creando Aristas
